    ...
    <>
      ...
      <aside className="store-drawer">
        ...
        <nav className="flex flex-1 flex-col gap-2 p-5">
          ...
          <Link href="/yonetici/login" className="store-drawer-link store-drawer-link-dark" onClick={onClose}>
          ...
          <Link href="/admin/login" className="store-drawer-link" onClick={onClose}>
            <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.75}>
